...
{   
    ...
    layer* layer0 = make_hidden_layer((layer**[]){&inLayer0}, 2, 1, 'u');
    if(layer0 == NULL)
    {
    ...
    layer* layer1 = make_hidden_layer((layer**[]){&inLayer1}, 1, 1, 'u');
    if(layer1 == NULL)
    {
    ...
    layer* layer2 = make_hidden_layer((layer**[]){&layer0, &layer1}, 3, 2, 'u');
    if(layer2 == NULL)
    {
