...
Model Structure
        ...
        inLayer----hiddenLayer0 ---  outLayer
                        ...
                        |h(t-1)
                        |        
    prevLayers --- hiddenLayer1 
                        .
                        .
                        .
                2 * context x windowSize
*/
...
int main() 
{
    ...
    layer* attnLayer0 = make_attention_layer((layer**[]){&hiddenLayer0}, 1, 1, windowSize, 'x');
    attnLayer0->layerType = 'a';

    layer* outLayer = make_output_layer((layer**[]){&attnLayer0}, 1, 1, 'g');
    if(outLayer == NULL)
    {
    ...
    model *myModel = construct_model((layer**[]){&inLayer0}, &outLayer, 4 + (2 * windowSize), 1, 1.0f, 'q');
    if(myModel == NULL)
    {
    ...
    //save_model(myModel, "test14Model.cml");
