...
int main()
{
    ...
    struct layer* inLayer0 = make_input_layer(3, 1, 0);
    if(inLayer0 == NULL)
    {
    ...
    struct layer* inLayer1 = make_input_layer(3, 1, 1);
    if(inLayer0 == NULL)
    {
    ...
    struct layer* inLayer2 = make_input_layer(3, 1, 2);
    if(inLayer0 == NULL)
    {
    ...
    struct layer* inLayerPrev0[] = {inLayer0}; 
    struct layer* denseLayer0 = make_dense_layer(inLayerPrev0, 3, 1, 1, 3);
    if(denseLayer0 == NULL)
    {
    ...
    struct layer* inLayerPrev1[] = {inLayer1};
    struct layer* denseLayer1 = make_dense_layer(inLayerPrev1, 3, 1, 1, 4);
    if(denseLayer1 == NULL)
    {
    ...
    struct layer* inLayerPrev2[] = {inLayer2};
    struct layer* denseLayer2 = make_dense_layer(inLayerPrev2, 3, 1, 1, 5);
    if(denseLayer2 == NULL)
    {
    ...
    struct layer* denseLayer3Prev[] = {denseLayer0, denseLayer1, denseLayer2};
    struct layer* denseLayer3 = make_dense_layer(denseLayer3Prev, 9, 3, 1, 6);
    if(denseLayer3 == NULL)
    {
    ...
    struct layer* denseLayer4Prev[] = {denseLayer3};
    struct layer* denseLayer4 = make_dense_layer(denseLayer4Prev, 3, 1, 1, 7);
    if(denseLayer4 == NULL)
    {
    ...
    struct layer* outLayerPrev[] = {denseLayer4};
    struct layer* outLayer = make_output_layer(outLayerPrev, 1, 1, 8);
    if(denseLayer2 == NULL)
    {
    ...
    struct model *wethrModel = construct_model(9, 3, 0.01f, 1);
    if(wethrModel == NULL)
    {
